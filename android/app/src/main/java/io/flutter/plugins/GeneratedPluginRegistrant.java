...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.dev4flutter.map_location_picker.MapLocationPickerPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin map_location_picker, com.dev4flutter.map_location_picker.MapLocationPickerPlugin", e);
    }
    try {
